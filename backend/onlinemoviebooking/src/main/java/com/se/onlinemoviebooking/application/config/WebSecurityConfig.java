...
import com.se.onlinemoviebooking.application.security.jwt.AuthEntryPointJwt;
import com.se.onlinemoviebooking.application.security.jwt.AuthTokenFilter;
...
public class WebSecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.cors().and().csrf().disable().exceptionHandling().authenticationEntryPoint(unauthorizedHandler).and()
				...
				.antMatchers("/api/auth/**").permitAll().antMatchers("/api/onlinemoviebooking/**").permitAll().antMatchers("/api/test/**").permitAll().anyRequest()
				.authenticated();
